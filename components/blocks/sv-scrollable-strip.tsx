...
interface SVScrollableStripProps {
  position: "top" | "bottom"
  isMinimized: boolean
...
export function SVScrollableStrip({
  position,
  isMinimized,
  onToggleMinimize,
  children,
  className,
}: SVScrollableStripProps) {
  ...
  // Drag functionality (same as top menu)
  ...
  // Scroll functionality (same as top menu)
  const scrollLeft = () => {
  ...
  // Drag event handlers (same as top menu)
  React.useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "bg-white/95 backdrop-blur-md border border-gray-200 rounded-2xl shadow-xl p-3",
